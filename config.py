...
# Embeddings dimension.
_C.CONCEPT_IDENTIFICATION.TRANSF_BASED.EMB_DIM = 16
# Hidden size
_C.CONCEPT_IDENTIFICATION.TRANSF_BASED.HIDDEN_SIZE = 40
# Number of layers.
_C.CONCEPT_IDENTIFICATION.TRANSF_BASED.NUM_LAYERS = 1
# Number of heads.
_C.CONCEPT_IDENTIFICATION.TRANSF_BASED.NUM_HEADS = 4
